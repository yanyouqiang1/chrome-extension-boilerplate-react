...
var options = {
    ...
    entry: {
        ...
        myfetch: path.join(__dirname, 'src', 'pages', 'Function','Usual','myfetch', 'index.jsx'),
        httpstrShow: path.join(__dirname, 'src', 'pages', 'Function','Usual','httpstrShow', 'index.jsx'),
        webRequest: path.join(__dirname, 'src', 'pages', 'Function','Usual','webRequest', 'index.jsx'),
    ...
    plugins: [
        ...
        new HtmlWebpackPlugin({
            template: path.join(__dirname, 'src', 'pages', 'Function','Usual','myfetch', 'index.html'),
            filename: 'myfetch.html',
            chunks: ['myfetch'],
            cache: false,
        }),
        new HtmlWebpackPlugin({
            template: path.join(__dirname, 'src', 'pages', 'Function','Usual','textRecord', 'index.html'),
        ...
        new HtmlWebpackPlugin({
            template: path.join(__dirname, 'src', 'pages', 'Function','Usual','webRequest', 'index.html'),
