...
const FetchList = () => {
    ...
    const doTry = (item) => {
        ...
        //cookies
        headers['cookie'] = request.cookies.map(it => it.name + "=" + it.value).join(";")
                            ...
                            <Collapse>
                                <Panel header={item.name} key="1" extra={<>
                                    ...
                                    <Row className="row">
                                        ...
                                        <Col span={20}><input className="inputText" type="text"
                                                              value={inputFields[item.key].name}
                                                              onChange={(e) => nameChange(e, item)}/></Col>
                                    </Row>
                                    <Row className="row">
                                        <Col span={2} className="left">url:</Col>
                                        <Col span={20}><input className="inputText" type="text"
                                                              value={inputFields[item.key].host ? inputFields[item.key].host : ""}
